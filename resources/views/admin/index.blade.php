...
<div class="container"> 
    ...
    <div class="col-md-12">
        ...
        <div class="alert alert-danger">
            <strong>Erro!</strong> {{ session('messageError') }}
        </div>
        @endif
                ...
                <div class="row">
                    <div class="col-md-12"> 
                        <a href='{{ url('/admin/user/add') }}'>
                            <input type='button' value='Adicionar utilizador' class='btn btn-small btn-success pull-right' style='margin-top: 10px; margin-bottom: 20px;'/>
                        </a>
                        <table class="table table-striped table-bordered table-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td align="center">
                                        <a class="btn btn-default" href='{{ URL::to('/admin/user/edit') .'/'. $user->id }}'><em class="fa fa-pencil"></em></a>
                                        <a class="btn btn-danger" href='{{ URL::to('/admin/user/delete') .'/'. $user->id }}'><em class="fa fa-trash"></em></a>
                                    </td>
                                </tr>
                                @endforeach
